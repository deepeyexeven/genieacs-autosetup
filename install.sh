...
cat << EOF
${GREEN}============================================================================${NC}
${GREEN}   ____            _         _    ____ ____    ___           _        _ _            ${NC}
${GREEN}  / ___| ___ _ __ (_) ___   / \  / ___/ ___|  |_ _|_ __  ___| |_ __ _| | | ___ _ __  ${NC}
${GREEN} | |  _ / _ \ '_ \| |/ _ \ / _ \| |   \___ \   | || '_ \/ __| __/ _\` | | |/ _ \ '__| ${NC}
${GREEN} | |_| |  __/ | | | |  __// ___ \ |___ ___) |  | || | | \__ \ || (_| | | |  __/ |    ${NC}
${GREEN}  \____|\___|_| |_|_|\___/_/   \_\____|____/  |___|_| |_|___/\__\__,_|_|_|\___|_|    ${NC}
${GREEN}============================================================================${NC}
${GREEN}                           Author: DeepEyexeven                             ${NC}
${GREEN}============================================================================${NC}
EOF
